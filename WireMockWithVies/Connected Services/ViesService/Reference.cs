...
namespace ViesService
{
    ...
    public interface checkVatPortType
    {
        ...
        System.Threading.Tasks.Task<ViesService.checkVatResponse> checkVatAsync(ViesService.checkVatRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<ViesService.checkVatApproxResponse> checkVatApproxAsync(ViesService.checkVatApproxRequest request);
    }
    ...
    public partial class checkVatApproxResponse
    {
        ...
        public checkVatApproxResponse(
                    ...
                    string traderCity, 
                    ViesService.matchCode traderNameMatch, 
                    ViesService.matchCode traderCompanyTypeMatch, 
                    ViesService.matchCode traderStreetMatch, 
                    ViesService.matchCode traderPostcodeMatch, 
                    ViesService.matchCode traderCityMatch, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface checkVatPortTypeChannel : ViesService.checkVatPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<ViesService.checkVatPortType>, ViesService.checkVatPortType
    {
        ...
        public System.Threading.Tasks.Task<ViesService.checkVatResponse> checkVatAsync(ViesService.checkVatRequest request)
        {
            return base.Channel.checkVatAsync(request);
        }
        
        public System.Threading.Tasks.Task<ViesService.checkVatApproxResponse> checkVatApproxAsync(ViesService.checkVatApproxRequest request)
        {
